import { WasteData } from "./utils.js";
const wasteForm = (data: WasteData) => {
    ...
    <g id="waste-page">
      ...
      <g id="body">
        ...
        <g id="generator-box">
          ...
          <text x="0.09in" y="0.117in">Generator:&nbsp&nbsp&nbsp&nbsp${
            data['waste-generator']
          }</text>
          <text x="0.09in" y="0.313in">Generator ID:&nbsp&nbsp&nbsp&nbsp&nbsp${
            data['waste-identifier']
          }</text>
          <text x="3.347in" y="0.313in">Business:&nbsp&nbsp&nbsp${
            data['waste-business']
          }</text>
        </g>
        <g id="waste-characterization-box">
          <g id="waste-description-box">
            ...
            <text x="8.635" y="94.647">
              ...
              <tspan id="process-description" x="8.635" dy="1.3em">${
                data['waste-process']
              }</tspan>
            </text>
          </g>
          <g id="waste-determination-box">
            ...
            <text x="9.475" y="192.590">
              <tspan id="user-knowledge">${
                data['waste-determination-0'] ? '☒' : '☐'
              }</tspan>
              <tspan> User knowledge (Process evaluation, SDSs, and interviews)</tspan>
            </text>
            <text x="9.475" y="211.630">
              <tspan id="waste-analysis">${
                data['waste-determination-1'] ? '☒' : '☐'
              }</tspan>
            ...
            <g id="listed-waste-box">
              ...
              <text x="240" y="264.607">
                ...
                <tspan id="p-codes" x="240" dy="1.5em">${
                  data['p-list-codes']
                }</tspan>
                <tspan id="u-codes" x="240" dy="1.5em">${
                  data['u-list-codes']
                }</tspan>
              </text>
              ...
              <text x="503.936" y="264.910">
                <tspan id="f-code-yes" x="503.936" dy="0">${
                  data['f-list-codes'] == '' ? '☐' : '☒'
                }</tspan>
                <tspan>Yes</tspan>
                <tspan id="p-code-yes" x="503.936" dy="1.5em">${
                  data['p-list-codes'] == '' ? '☐' : '☒'
                }</tspan>
                <tspan>Yes</tspan>
                <tspan id="u-code-yes" x="503.936" dy="1.5em">${
                  data['u-list-codes'] == '' ? '☐' : '☒'
                }</tspan>
                <tspan>Yes</tspan>
              </text>
              <text x="578.376" y="264.910">
                <tspan id="f-code-no" x="578.376" dy="0">${
                  data['f-list-codes'] == '' ? '☒' : '☐'
                }</tspan>
                <tspan>No</tspan>
                <tspan id="p-code-no" x="578.376" dy="1.5em">${
                  data['p-list-codes'] == '' ? '☒' : '☐'
                }</tspan>
                <tspan>No</tspan>
                <tspan id="u-code-no" x="578.376" dy="1.5em">${
                  data['u-list-codes'] == '' ? '☒' : '☐'
                }</tspan>
                <tspan>No</tspan>
              </text>
            ...
            <g id="characteristic-waste-box">
              ...
              <text x="240.670" y="418.545">
                <tspan id="flash-point" x="230" dy="0">${
                  data['ignitable']
                }</tspan>
              ...
              <text x="503.936" y="419.017">
                <tspan id="D001-yes" x="503.936" dy="0">${
                  data['ignitable'] == '' ? '☐' : '☒'
                }</tspan>
                <tspan>Yes</tspan>
                <tspan id="D002-yes" x="503.936" dy="1.5em">${
                  data['corrosive'] == '' ? '☐' : '☒'
                }</tspan>
                <tspan>Yes</tspan>
                <tspan id="D003-yes" x="503.936" dy="1.5em">${
                  data['reactive'] == '' ? '☐' : '☒'
                }</tspan>
                <tspan>Yes</tspan>
              </text>
              <text x="578.376" y="419.017">
                <tspan id="D001-no" x="578.376" dy="0">${
                  data['ignitable'] == '' ? '☒' : '☐'
                }</tspan>
                <tspan>No</tspan>
                <tspan id="D002-no" x="578.376" dy="1.5em">${
                  data['corrosive'] == '' ? '☒' : '☐'
                }</tspan>
                <tspan>No</tspan>
                <tspan id="D003-no" x="578.376" dy="1.5em">${
                  data['reactive'] == '' ? '☒' : '☐'
                }</tspan>
                <tspan>No</tspan>
              </text>
